...
const add = function (a, b, c) {    // параметры
...
const add1 = function (a, b, c) { // параметры
    console.log(a);
    console.log(b);
    console.log(c);
...
const add3 = function () {      // не пишем параметры
...
// ========================================
// операцию ... (rest)
const add5 = function (mult, ...args) {     // собирает список аргументов
